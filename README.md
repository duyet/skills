...
| `duyetbot-knowledge` | Everything duyetbot needs to know about its owner (Duyet Le) and how to behave — knowledge sources, update triggers, transparency patterns, and communication rules. |
