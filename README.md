...
| `engineering-discipline` | Core engineering principles for sustainable, maintainable code. No shortcuts, no hacks. Quality gates before completion. |
| `quality-gates` | Systematic quality verification procedures for code review and delivery. Use when validating completed work, conducting code reviews, or ensuring production readiness. |
...
| `orchestration` | Orchestrate complex work through parallel agent coordination. Decompose requests into task graphs, spawn background workers, and synthesize results elegantly. Covers task decomposition, iterative execution loops, and team agent coordination. |
